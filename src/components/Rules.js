...
function Rules() {
    const languages = {
        en: [<><p>Players take turns in drawing lines between dots on a grid. The player who completes the most boxes wins.</p>
            ...
            <p>When all the boxes have been completed the winner is the player who has more points.</p></>, <h1>Game rules</h1>],
        pl: [<><p>Gracze na zmianę rysują linie między kropkami na siatce. Gracz, który zajmie najwięcej kwadratów, wygrywa.</p>
            ...
            <p> Gdy wszystkie pola zostaną wypełnione, zwycięzcą zostaje gracz, który ma więcej punktów.</p></>, <h1>Zasady gry</h1>],
        ru: [<><p>Игроки по очереди рисуют линии между точками на сетке. Побеждает игрок, занявший наибольшее количество квадратов.</p>
            ...
            <p>Когда все квадраты будут заняты, победителем становится игрок, набравший найбольшее количество баллов.</p> </>, <h1>Правила игры</h1>]
    }
